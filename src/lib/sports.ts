...
export interface SportConfig {
  ...
  fixedHandicaps?: number[]; // baseball/hockey: ±1.5 is the market; basketball uses a ladder
...
export const SPORTS: Record<SportId, SportConfig> = {
  ...
  baseball: {
    ...
    model: "count", halfHalfLines: true, totalStep: 1, spreadStep: 1, segStep: 1, ladderWidth: 3, fixedHandicaps: [-1.5, 1.5], defaultSegShare: 0.556,
  ...
  hockey: {
    ...
    model: "count", halfHalfLines: true, totalStep: 1, spreadStep: 1, segStep: 1, ladderWidth: 2, fixedHandicaps: [-1.5, 1.5], defaultSegShare: 0.31,
